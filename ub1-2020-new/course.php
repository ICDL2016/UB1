...
<div class="course-form">
    ...
    <div class="course-form__block">
        ...
        <form class="course-form__form">
            ...
            <div class="form-input__span form-input__span-email">Поле "Email" обязательно для заполнения и должно
                содержать
    ...
    <div class="container">
        <div class="start-block">
            ...
            <div class="start-text course-start__text">
                Пройдите обучение по курсу <span>Менеджмент, управление организаций и персоналом</span> и мы поможем вам
                найти
